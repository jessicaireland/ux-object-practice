...
describe = () => {
    let description = `A ${this.type} which has ${this.leafColor} leaves that ${this.leafDescription}. The flowers are ${this.flowerColor}`;
...
class Garden {
    ...
    describe(){
    let description = `${this.name} has ${this.plants.length} types of plants in it. The garden contains`;
...
class Estate {
    ...
    describe(){
        ...
        let description = `Our estate has ${estateLength} gardens.`;
...
function describePlant(plant) {
    let description = `A ${plant.type} which has ${plant.leafColor} leaves that ${plant.leafDescription}. The flowers are ${plant.flowerColor}`;
...
function describeGarden(gardenName, listOfPlants) {
    let description = `${gardenName} has ${listOfPlants.length} types of plants in it. The garden contains`;
...
function describeEstate(estate) {
    // const estateLenght = estate.lenght
    let description = `Our estate has ${estate.lenght} +  gardens.`;
...
function cloneAllTheRosesAndChangeTheirColors(estate) {
    let cloneRoses = [];
    for (let gardenName in estate){
        let gardenName = estate[gardenName];
    ...
    // for (newColors of plant.flowerColor){
    //     changeColorOfPlant.plant (newColors + estate);
    // }
    // for each rose...
